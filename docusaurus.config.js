...
const config = {
  ...
  organizationName: 'milan199422', // Usually your GitHub org/user name.
  ...
  presets: [
   ...
   // === START: Neuer Abschnitt "plugins" für das zweite Docs-Plugin ===/////////////////////////////////////
   plugins: [
    [
      '@docusaurus/plugin-content-docs',
      {
        id: 'test',                         // Eindeutige ID
        path: 'test',                       // Ordner für den Test-Bereich
        routeBasePath: 'test',              // URL-Pfad (z.B. /test)
        sidebarPath: require.resolve('./sidebarsTest.js'),
      },
    ],
  ],
  // === END: Neuer Abschnitt "plugins" für das zweite Docs-Plugin === ////////////////////////////////////
